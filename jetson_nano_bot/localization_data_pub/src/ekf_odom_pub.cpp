...
const double TICKS_PER_REVOLUTION = 420; // For reference purposes.
const double WHEEL_RADIUS = 0.105; // Wheel radius in meters
const double WHEEL_BASE = 0.277; // Center of left tire to center of right tire
const double TICKS_PER_METER = 636.61977; // Original was 2800
